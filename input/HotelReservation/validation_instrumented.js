...
function isValidCard(cardNumber) {
  ...
  if (confixWrapper("condition", "cardNumber.length < 11", ["cardNumber", "ccard", "i", "sum"], [cardNumber, ccard, i, sum], "isValidCard", cardNumber.length < 11)) 
  {
    return confixWrapper("return", "return false;", [""], [], "isValidCard", false);
  }
  for (i = confixWrapper("infix", "i = 0", [""], [], "isValidCard", 0); confixWrapper("loopCondition", "i < cardNumber.length", [""], [], "isValidCard", i < cardNumber.length); i++) 
    {
  ...
  for (i = confixWrapper("infix", "i = 0", [""], [], "isValidCard", 0); confixWrapper("loopCondition", "i < cardNumber.length", [""], [], "isValidCard", i < cardNumber.length); i = confixWrapper("infix", "i = i + 2", [""], [], "isValidCard", i + 2)) 
    {
      ccard[i] = confixWrapper("infix", "ccard[i] = ccard[i] * 2", [""], [], "isValidCard", ccard[i] * 2);
      if (confixWrapper("condition", "ccard[i] > 9", ["cardNumber", "ccard", "i", "sum"], [cardNumber, ccard, i, sum], "isValidCard", ccard[i] > 9)) 
      {
...
function isValidVISA(cardNumber) {
  if (confixWrapper("condition", "confixWrapper(\"functionCall\", \"cardNumber.charAt(0)\", [\"0\"], [0], \"isValidVISA\", cardNumber.charAt(0)) == '4' && (cardNumber.length == 13 || cardNumber.length == 16)", ["cardNumber"], [cardNumber], "isValidVISA", confixWrapper("functionCall", "cardNumber.charAt(0)", ["0"], [0], "isValidVISA", cardNumber.charAt(0)) == '4' && (cardNumber.length == 13 || cardNumber.length == 16))) 
  {
...
function checkPassConfirm() {
  ...
  if (confixWrapper("condition", "pass != c_pass", ["pass", "c_pass"], [pass, c_pass], "checkPassConfirm", pass != c_pass)) 
  {
...
function isValidMasterCard(cardNumber) {
  if (confixWrapper("condition", "confixWrapper(\"functionCall\", \"cardNumber.charAt(0)\", [\"0\"], [0], \"isValidMasterCard\", cardNumber.charAt(0)) == '5' && (confixWrapper(\"functionCall\", \"cardNumber.charAt(1)\", [\"1\"], [1], \"isValidMasterCard\", cardNumber.charAt(1)) == '1' || confixWrapper(\"functionCall\", \"cardNumber.charAt(1)\", [\"1\"], [1], \"isValidMasterCard\", cardNumber.charAt(1)) == '5') && cardNumber.length == 16", ["cardNumber"], [cardNumber], "isValidMasterCard", confixWrapper("functionCall", "cardNumber.charAt(0)", ["0"], [0], "isValidMasterCard", cardNumber.charAt(0)) == '5' && (confixWrapper("functionCall", "cardNumber.charAt(1)", ["1"], [1], "isValidMasterCard", cardNumber.charAt(1)) == '1' || confixWrapper("functionCall", "cardNumber.charAt(1)", ["1"], [1], "isValidMasterCard", cardNumber.charAt(1)) == '5') && cardNumber.length == 16)) 
  {
...
function checkValid() {
  ...
  if (confixWrapper("condition", "confixWrapper(\"functionCall\", \"document.getElementById('c1')\", [\"c1\"], ['c1'], \"checkValid\", document.getElementById('c1')).checked", ["cardNumber"], [cardNumber], "checkValid", confixWrapper("functionCall", "document.getElementById('c1')", ["c1"], ['c1'], "checkValid", document.getElementById('c1')).checked)) 
  {
    if (confixWrapper("condition", "!confixWrapper(\"functionCall\", \"isValidVISA(cardNumber)\", [\"cardNumber\"], [cardNumber], \"checkValid\", isValidVISA(cardNumber))", ["cardNumber"], [cardNumber], "checkValid", !confixWrapper("functionCall", "isValidVISA(cardNumber)", ["cardNumber"], [cardNumber], "checkValid", isValidVISA(cardNumber)))) 
    {
  ...
  if (confixWrapper("condition", "confixWrapper(\"functionCall\", \"document.getElementById('c2')\", [\"c2\"], ['c2'], \"checkValid\", document.getElementById('c2')).checked", ["cardNumber"], [cardNumber], "checkValid", confixWrapper("functionCall", "document.getElementById('c2')", ["c2"], ['c2'], "checkValid", document.getElementById('c2')).checked)) 
  {
    if (confixWrapper("condition", "!confixWrapper(\"functionCall\", \"isValidMasterCard(cardNumber)\", [\"cardNumber\"], [cardNumber], \"checkValid\", isValidMasterCard(cardNumber))", ["cardNumber"], [cardNumber], "checkValid", !confixWrapper("functionCall", "isValidMasterCard(cardNumber)", ["cardNumber"], [cardNumber], "checkValid", isValidMasterCard(cardNumber)))) 
    {
...
function RequiredField(f) {
  var i, field;
  for (i = confixWrapper("infix", "i = 0", [""], [], "RequiredField", 0); confixWrapper("loopCondition", "i < f.elements.length", [""], [], "RequiredField", i < f.elements.length); i++) 
    {
      ...
      if (confixWrapper("condition", "value == \"\" || value == null", ["f", "i", "field"], [f, i, field], "RequiredField", value == "" || value == null)) 
      {
...
function validateEmail() {
  ...
  if (confixWrapper("condition", "atpos < 1 || dotpos < atpos + 2 || dotpos + 2 >= x.length", ["x", "atpos", "dotpos"], [x, atpos, dotpos], "validateEmail", atpos < 1 || dotpos < atpos + 2 || dotpos + 2 >= x.length)) 
  {
...
function validateNumber(f) {
  ...
  if (confixWrapper("condition", "confixWrapper(\"functionCall\", \"input.match(number)\", [\"number\"], [number], \"validateNumber\", input.match(number))", ["f", "number"], [f, number], "validateNumber", confixWrapper("functionCall", "input.match(number)", ["number"], [number], "validateNumber", input.match(number)))) 
  {
