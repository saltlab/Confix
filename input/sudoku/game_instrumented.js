...
function shuffleBoard() {
  for (var counter = confixWrapper("initvar", "var counter = 0", [""], [], "shuffleBoard", 0); confixWrapper("loopCondition", "counter < 30", [""], [], "shuffleBoard", counter < 30); counter++) 
    {
      ...
      for (var no = confixWrapper("initvar", "var no = 0", [""], [], "shuffleBoard", 0); confixWrapper("loopCondition", "no < squareObjects.length", [""], [], "shuffleBoard", no < squareObjects.length); no++) 
        {
          ...
          if (confixWrapper("condition", "txtObj.innerHTML == number1", ["counter", "number1", "number2", "tmpObjects1", "tmpObjects2", "no", "txtObj", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [counter, number1, number2, tmpObjects1, tmpObjects2, no, txtObj, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "shuffleBoard", txtObj.innerHTML == number1)) 
          confixWrapper("functionCall", "tmpObjects1.push(txtObj)", ["txtObj"], [txtObj], "shuffleBoard", tmpObjects1.push(txtObj));
          if (confixWrapper("condition", "txtObj.innerHTML == number2", ["counter", "number1", "number2", "tmpObjects1", "tmpObjects2", "no", "txtObj", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [counter, number1, number2, tmpObjects1, tmpObjects2, no, txtObj, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "shuffleBoard", txtObj.innerHTML == number2)) 
          confixWrapper("functionCall", "tmpObjects2.push(txtObj)", ["txtObj"], [txtObj], "shuffleBoard", tmpObjects2.push(txtObj));
        }
      for (var no = confixWrapper("initvar", "var no = 0", [""], [], "shuffleBoard", 0); confixWrapper("loopCondition", "no < tmpObjects1.length", [""], [], "shuffleBoard", no < tmpObjects1.length); no++) 
        {
...
function resetVisibleNumberArray() {
  for (var no = confixWrapper("initvar", "var no = 0", [""], [], "resetVisibleNumberArray", 0); confixWrapper("loopCondition", "no <= 9", [""], [], "resetVisibleNumberArray", no <= 9); no++) 
    {
...
function newGame() {
  ...
  for (var no = confixWrapper("initvar", "var no = 0", [""], [], "newGame", 0); confixWrapper("loopCondition", "no < subObjects.length", [""], [], "newGame", no < subObjects.length); no++) 
    {
      if (confixWrapper("condition", "subObjects[no].className == 'sudokuSquare'", ["obj", "subObjects", "no", "spans", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [obj, subObjects, no, spans, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "newGame", subObjects[no].className == 'sudokuSquare')) 
      {
...
function showCell(inputDiv) {
  if (confixWrapper("condition", "inputDiv == 'generateDOMInput'", ["inputDiv", "span", "typingSpan", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [inputDiv, span, typingSpan, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "showCell", inputDiv == 'generateDOMInput')) 
  inputDiv = confixWrapper("infix", "inputDiv = confixWrapper(\"functionCall\", \"document.getElementById('ConfixDummyNode1')\", [\"ConfixDummyNode1\"], ['ConfixDummyNode1'], \"showCell\", document.getElementById('ConfixDummyNode1'))", [""], [], "showCell", confixWrapper("functionCall", "document.getElementById('ConfixDummyNode1')", ["ConfixDummyNode1"], ['ConfixDummyNode1'], "showCell", document.getElementById('ConfixDummyNode1')));
...
function showColumnsInGroup() {
  ...
  if (confixWrapper("condition", "level <= 0", ["object", "cellsRevealed", "numberArray", "groupCountArray", "maxInGroup", "no", "row", "col", "obj", "parentID", "span", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [object, cellsRevealed, numberArray, groupCountArray, maxInGroup, no, row, col, obj, parentID, span, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "showColumnsInGroup", level <= 0)) 
  level = confixWrapper("infix", "level = 1", [""], [], "showColumnsInGroup", 1);
  if (confixWrapper("condition", "level == 1", ["object", "cellsRevealed", "numberArray", "groupCountArray", "maxInGroup", "no", "row", "col", "obj", "parentID", "span", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [object, cellsRevealed, numberArray, groupCountArray, maxInGroup, no, row, col, obj, parentID, span, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "showColumnsInGroup", level == 1)) 
  maxInGroup = confixWrapper("infix", "maxInGroup = 4", [""], [], "showColumnsInGroup", 4);
  for (var no = confixWrapper("initvar", "var no = 0", [""], [], "showColumnsInGroup", 0); confixWrapper("loopCondition", "no < countSquares[level]", [""], [], "showColumnsInGroup", no < countSquares[level]); no++) 
    {
do {
        ...
        if (confixWrapper("condition", "!numberArray[span.innerHTML]", ["object", "cellsRevealed", "numberArray", "groupCountArray", "maxInGroup", "no", "row", "col", "obj", "parentID", "span", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [object, cellsRevealed, numberArray, groupCountArray, maxInGroup, no, row, col, obj, parentID, span, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "showColumnsInGroup", !numberArray[span.innerHTML])) 
        numberArray[span.innerHTML] = confixWrapper("infix", "numberArray[span.innerHTML] = 0", [""], [], "showColumnsInGroup", 0);
        if (confixWrapper("condition", "!groupCountArray[parentID]", ["object", "cellsRevealed", "numberArray", "groupCountArray", "maxInGroup", "no", "row", "col", "obj", "parentID", "span", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [object, cellsRevealed, numberArray, groupCountArray, maxInGroup, no, row, col, obj, parentID, span, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "showColumnsInGroup", !groupCountArray[parentID])) 
...
function highlightSquare(e, inputObj) {
  var hintDiv = confixWrapper("initvar", "var hintDiv = confixWrapper(\"functionCall\", \"document.getElementById('hintDiv')\", [\"hintDiv\"], ['hintDiv'], \"highlightSquare\", document.getElementById('hintDiv'))", [""], [], "highlightSquare", confixWrapper("functionCall", "document.getElementById('hintDiv')", ["hintDiv"], ['hintDiv'], "highlightSquare", document.getElementById('hintDiv')));
  if (confixWrapper("condition", "hintDiv", ["e", "inputObj", "hintDiv", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [e, inputObj, hintDiv, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "highlightSquare", hintDiv)) 
  hintDiv.style.display = confixWrapper("infix", "hintDiv.style.display = 'none'", [""], [], "highlightSquare", 'none');
  if (confixWrapper("condition", "inputObj.style == undefined", ["e", "inputObj", "hintDiv", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [e, inputObj, hintDiv, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "highlightSquare", inputObj.style == undefined)) 
  return;
  if (confixWrapper("condition", "gameFinished", ["e", "inputObj", "hintDiv", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [e, inputObj, hintDiv, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "highlightSquare", gameFinished)) 
  return;
  ...
  if (confixWrapper("condition", "higlightedCell && higlightedCell != inputObj", ["e", "inputObj", "hintDiv", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [e, inputObj, hintDiv, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "highlightSquare", higlightedCell && higlightedCell != inputObj)) 
...
function isGameFinished() {
  ...
  for (var no = confixWrapper("initvar", "var no = 0", [""], [], "isGameFinished", 0); confixWrapper("loopCondition", "no < subDivs.length", [""], [], "isGameFinished", no < subDivs.length); no++) 
    {
      if (confixWrapper("condition", "confixWrapper(\"functionCall\", \"subDivs[no].className.indexOf('sudokuSquare')\", [\"sudokuSquare\"], ['sudokuSquare'], \"isGameFinished\", subDivs[no].className.indexOf('sudokuSquare')) >= 0 && !subDivs[no].style.backgroundColor", ["obj", "subDivs", "allOk", "no", "spans", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [obj, subDivs, allOk, no, spans, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "isGameFinished", confixWrapper("functionCall", "subDivs[no].className.indexOf('sudokuSquare')", ["sudokuSquare"], ['sudokuSquare'], "isGameFinished", subDivs[no].className.indexOf('sudokuSquare')) >= 0 && !subDivs[no].style.backgroundColor)) 
      {
        ...
        if (confixWrapper("condition", "spans[0].innerHTML != spans[1].innerHTML", ["obj", "subDivs", "allOk", "no", "spans", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [obj, subDivs, allOk, no, spans, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "isGameFinished", spans[0].innerHTML != spans[1].innerHTML)) 
        {
  ...
  if (confixWrapper("condition", "allOk", ["obj", "subDivs", "allOk", "no", "spans", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [obj, subDivs, allOk, no, spans, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "isGameFinished", allOk)) 
...
function initSudoku() {
  ...
  for (var rowCounter = confixWrapper("initvar", "var rowCounter = 0", [""], [], "initSudoku", 0); confixWrapper("loopCondition", "rowCounter < 9", [""], [], "initSudoku", rowCounter < 9); rowCounter++) 
    {
      matrix[rowCounter] = confixWrapper("infix", "matrix[rowCounter] = new Array()", [""], [], "initSudoku", new Array());
      for (var colCounter = confixWrapper("initvar", "var colCounter = 0", [""], [], "initSudoku", 0); confixWrapper("loopCondition", "colCounter < 9", [""], [], "initSudoku", colCounter < 9); colCounter++) 
        {
          ...
          if (confixWrapper("condition", "number > 9", ["matrix", "rowCounter", "colCounter", "number", "no", "no2", "tmpMatrix", "no3", "obj", "spanObjects", "span", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [matrix, rowCounter, colCounter, number, no, no2, tmpMatrix, no3, obj, spanObjects, span, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "initSudoku", number > 9)) 
          number = confixWrapper("infix", "number = number % 9", [""], [], "initSudoku", number % 9);
          if (confixWrapper("condition", "number == 0", ["matrix", "rowCounter", "colCounter", "number", "no", "no2", "tmpMatrix", "no3", "obj", "spanObjects", "span", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [matrix, rowCounter, colCounter, number, no, no2, tmpMatrix, no3, obj, spanObjects, span, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "initSudoku", number == 0)) 
  ...
  for (var no = confixWrapper("initvar", "var no = 0", [""], [], "initSudoku", 0); confixWrapper("loopCondition", "no < 9", [""], [], "initSudoku", no < 9); no += 3) 
    {
      for (var no2 = confixWrapper("initvar", "var no2 = 0", [""], [], "initSudoku", 0); confixWrapper("loopCondition", "no2 < 3", [""], [], "initSudoku", no2 < 3); no2++) 
        {
      ...
      for (var no2 = confixWrapper("initvar", "var no2 = 0", [""], [], "initSudoku", 0); confixWrapper("loopCondition", "no2 < 3", [""], [], "initSudoku", no2 < 3); no2++) 
        {
          ...
          var tmpMatrix = confixWrapper("initvar", "var tmpMatrix = new Array()", [""], [], "initSudoku", new Array());
          for (var no3 = confixWrapper("initvar", "var no3 = 0", [""], [], "initSudoku", 0); confixWrapper("loopCondition", "no3 < matrix.length", [""], [], "initSudoku", no3 < matrix.length); no3++) 
            {
  ...
  for (var no = confixWrapper("initvar", "var no = 0", [""], [], "initSudoku", 0); confixWrapper("loopCondition", "no < matrix.length", [""], [], "initSudoku", no < matrix.length); no++) 
    {
      for (var no2 = confixWrapper("initvar", "var no2 = 0", [""], [], "initSudoku", 0); confixWrapper("loopCondition", "no2 < matrix[no].length", [""], [], "initSudoku", no2 < matrix[no].length); no2++) 
        {
  ...
  if (confixWrapper("condition", "document.all", ["matrix", "rowCounter", "colCounter", "number", "no", "no2", "tmpMatrix", "no3", "obj", "spanObjects", "span", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [matrix, rowCounter, colCounter, number, no, no2, tmpMatrix, no3, obj, spanObjects, span, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "initSudoku", document.all)) 
  {
...
var code = confixWrapper("initvar", "var code = 0", [""], [], "", 0);
function insertNumber(e) {
  confixWrapper("functionCall", "document.getElementById('hintDiv')", ["hintDiv"], ['hintDiv'], "insertNumber", document.getElementById('hintDiv')).style.display = confixWrapper("infix", "confixWrapper(\"functionCall\", \"document.getElementById('hintDiv')\", [\"hintDiv\"], ['hintDiv'], \"insertNumber\", document.getElementById('hintDiv')).style.display = 'none'", [""], [], "insertNumber", 'none');
  if (confixWrapper("condition", "document.all", ["e", "span", "numbers", "row", "col", "nextObject", "theChar", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [e, span, numbers, row, col, nextObject, theChar, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "insertNumber", document.all)) 
  e = confixWrapper("infix", "e = event", [""], [], "insertNumber", event);
  if (confixWrapper("condition", "!higlightedCell", ["e", "span", "numbers", "row", "col", "nextObject", "theChar", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [e, span, numbers, row, col, nextObject, theChar, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "insertNumber", !higlightedCell)) 
  return;
  if (confixWrapper("condition", "gameFinished", ["e", "span", "numbers", "row", "col", "nextObject", "theChar", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [e, span, numbers, row, col, nextObject, theChar, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "insertNumber", gameFinished)) 
  return;
  ...
  if (confixWrapper("condition", "code == 39", ["e", "span", "numbers", "row", "col", "nextObject", "theChar", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [e, span, numbers, row, col, nextObject, theChar, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "insertNumber", code == 39)) 
  {
    if (confixWrapper("condition", "col < 8", ["e", "span", "numbers", "row", "col", "nextObject", "theChar", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [e, span, numbers, row, col, nextObject, theChar, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "insertNumber", col < 8)) 
    {
      ...
      if (confixWrapper("condition", "nextObject.style.backgroundColor", ["e", "span", "numbers", "row", "col", "nextObject", "theChar", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [e, span, numbers, row, col, nextObject, theChar, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "insertNumber", nextObject.style.backgroundColor)) 
      {
  ...
  if (confixWrapper("condition", "code == 37", ["e", "span", "numbers", "row", "col", "nextObject", "theChar", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [e, span, numbers, row, col, nextObject, theChar, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "insertNumber", code == 37)) 
  {
    if (confixWrapper("condition", "col > 0", ["e", "span", "numbers", "row", "col", "nextObject", "theChar", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [e, span, numbers, row, col, nextObject, theChar, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "insertNumber", col > 0)) 
    {
      nextObject = confixWrapper("infix", "nextObject = confixWrapper(\"functionCall\", \"document.getElementById('square_' + row + '_' + (col / 1 - 1))\", [\"square_ + row + _ + (col / 1 - 1)\"], ['square_' + row + '_' + (col / 1 - 1)], \"insertNumber\", document.getElementById('square_' + row + '_' + (col / 1 - 1)))", [""], [], "insertNumber", confixWrapper("functionCall", "document.getElementById('square_' + row + '_' + (col / 1 - 1))", ["square_ + row + _ + (col / 1 - 1)"], ['square_' + row + '_' + (col / 1 - 1)], "insertNumber", document.getElementById('square_' + row + '_' + (col / 1 - 1))));
      if (confixWrapper("condition", "nextObject.style.backgroundColor", ["e", "span", "numbers", "row", "col", "nextObject", "theChar", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [e, span, numbers, row, col, nextObject, theChar, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "insertNumber", nextObject.style.backgroundColor)) 
      {
  ...
  if (confixWrapper("condition", "code == 38", ["e", "span", "numbers", "row", "col", "nextObject", "theChar", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [e, span, numbers, row, col, nextObject, theChar, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "insertNumber", code == 38)) 
  {
    if (confixWrapper("condition", "row > 0", ["e", "span", "numbers", "row", "col", "nextObject", "theChar", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [e, span, numbers, row, col, nextObject, theChar, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "insertNumber", row > 0)) 
    {
  ...
  if (confixWrapper("condition", "code == 40", ["e", "span", "numbers", "row", "col", "nextObject", "theChar", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [e, span, numbers, row, col, nextObject, theChar, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "insertNumber", code == 40)) 
  {
    if (confixWrapper("condition", "row < 8", ["e", "span", "numbers", "row", "col", "nextObject", "theChar", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [e, span, numbers, row, col, nextObject, theChar, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "insertNumber", row < 8)) 
    {
      nextObject = confixWrapper("infix", "nextObject = confixWrapper(\"functionCall\", \"document.getElementById('square_' + (row + 1) + '_' + col)\", [\"square_ + (row + 1) + _ + col\"], ['square_' + (row + 1) + '_' + col], \"insertNumber\", document.getElementById('square_' + (row + 1) + '_' + col))", [""], [], "insertNumber", confixWrapper("functionCall", "document.getElementById('square_' + (row + 1) + '_' + col)", ["square_ + (row + 1) + _ + col"], ['square_' + (row + 1) + '_' + col], "insertNumber", document.getElementById('square_' + (row + 1) + '_' + col)));
      if (confixWrapper("condition", "nextObject.style.backgroundColor", ["e", "span", "numbers", "row", "col", "nextObject", "theChar", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [e, span, numbers, row, col, nextObject, theChar, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "insertNumber", nextObject.style.backgroundColor)) 
      {
  ...
  if (confixWrapper("condition", "nextObject", ["e", "span", "numbers", "row", "col", "nextObject", "theChar", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [e, span, numbers, row, col, nextObject, theChar, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "insertNumber", nextObject)) 
  {
  ...
  if (confixWrapper("condition", "code == 46 || code == 8", ["e", "span", "numbers", "row", "col", "nextObject", "theChar", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [e, span, numbers, row, col, nextObject, theChar, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "insertNumber", code == 46 || code == 8)) 
  {
    span.innerHTML = confixWrapper("infix", "span.innerHTML = ''", [""], [], "insertNumber", '');
    if (confixWrapper("condition", "code == 8", ["e", "span", "numbers", "row", "col", "nextObject", "theChar", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [e, span, numbers, row, col, nextObject, theChar, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "insertNumber", code == 8)) 
    return confixWrapper("return", "return false;", [""], [], "insertNumber", false);
  }
  if (confixWrapper("condition", "code > 96 && code <= 105", ["e", "span", "numbers", "row", "col", "nextObject", "theChar", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [e, span, numbers, row, col, nextObject, theChar, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "insertNumber", code > 96 && code <= 105)) 
  code -= 48;
  if (confixWrapper("condition", "code > 48 && code <= 57", ["e", "span", "numbers", "row", "col", "nextObject", "theChar", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [e, span, numbers, row, col, nextObject, theChar, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "insertNumber", code > 48 && code <= 57)) 
  {
...
function helpMe() {
  if (confixWrapper("condition", "gameFinished", ["allreadyRevealed", "counter", "row", "col", "el", "spans", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [allreadyRevealed, counter, row, col, el, spans, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "helpMe", gameFinished)) 
  return confixWrapper("return", "return false;", [""], [], "helpMe", false);
  if (confixWrapper("condition", "confixWrapper(\"functionCall\", \"confirm('Do you want me to reveal a number for you?')\", [\"Do you want me to reveal a number for you?\"], ['Do you want me to reveal a number for you?'], \"helpMe\", confirm('Do you want me to reveal a number for you?'))", ["allreadyRevealed", "counter", "row", "col", "el", "spans", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [allreadyRevealed, counter, row, col, el, spans, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "helpMe", confixWrapper("functionCall", "confirm('Do you want me to reveal a number for you?')", ["Do you want me to reveal a number for you?"], ['Do you want me to reveal a number for you?'], "helpMe", confirm('Do you want me to reveal a number for you?')))) 
  {
...
do {
      ...
      if (confixWrapper("condition", "spans[1].innerHTML.length == 0", ["allreadyRevealed", "counter", "row", "col", "el", "spans", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [allreadyRevealed, counter, row, col, el, spans, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "helpMe", spans[1].innerHTML.length == 0)) 
      {
      ...
      if (confixWrapper("condition", "el.style.backgroundColor", ["allreadyRevealed", "counter", "row", "col", "el", "spans", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [allreadyRevealed, counter, row, col, el, spans, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "helpMe", el.style.backgroundColor)) 
...
function isCorrect(divObj) {
  if (confixWrapper("condition", "divObj == 'generateDOMInput'", ["divObj", "spans", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [divObj, spans, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "isCorrect", divObj == 'generateDOMInput')) 
  divObj = confixWrapper("infix", "divObj = confixWrapper(\"functionCall\", \"document.getElementByID('ConfixDummyNode1')\", [\"ConfixDummyNode1\"], ['ConfixDummyNode1'], \"isCorrect\", document.getElementByID('ConfixDummyNode1'))", [""], [], "isCorrect", confixWrapper("functionCall", "document.getElementByID('ConfixDummyNode1')", ["ConfixDummyNode1"], ['ConfixDummyNode1'], "isCorrect", document.getElementByID('ConfixDummyNode1')));
  ...
  if (confixWrapper("condition", "spans[0].innerHTML == spans[1].innerHTML || spans[1].innerHTML.length == 0", ["divObj", "spans", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [divObj, spans, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "isCorrect", spans[0].innerHTML == spans[1].innerHTML || spans[1].innerHTML.length == 0)) 
...
function getPossibleNumbers(inputObj) {
  if (confixWrapper("condition", "inputObj == 'generateDOMInput'", ["inputObj", "noArray", "countNumbers", "spans", "parentDiv", "subDivs", "no", "numbers", "row", "col", "obj", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [inputObj, noArray, countNumbers, spans, parentDiv, subDivs, no, numbers, row, col, obj, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "getPossibleNumbers", inputObj == 'generateDOMInput')) 
  inputObj = confixWrapper("infix", "inputObj = confixWrapper(\"functionCall\", \"document.getElementByID('ConfixDummyNode1')\", [\"ConfixDummyNode1\"], ['ConfixDummyNode1'], \"getPossibleNumbers\", document.getElementByID('ConfixDummyNode1'))", [""], [], "getPossibleNumbers", confixWrapper("functionCall", "document.getElementByID('ConfixDummyNode1')", ["ConfixDummyNode1"], ['ConfixDummyNode1'], "getPossibleNumbers", document.getElementByID('ConfixDummyNode1')));
  ...
  if (confixWrapper("condition", "spans[0].innerHTML == spans[1].innerHTML", ["inputObj", "noArray", "countNumbers", "spans", "parentDiv", "subDivs", "no", "numbers", "row", "col", "obj", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [inputObj, noArray, countNumbers, spans, parentDiv, subDivs, no, numbers, row, col, obj, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "getPossibleNumbers", spans[0].innerHTML == spans[1].innerHTML)) 
  ...
  for (var no = confixWrapper("initvar", "var no = 0", [""], [], "getPossibleNumbers", 0); confixWrapper("loopCondition", "no < subDivs.length", [""], [], "getPossibleNumbers", no < subDivs.length); no++) 
    {
      if (confixWrapper("condition", "subDivs[no] != inputObj", ["inputObj", "noArray", "countNumbers", "spans", "parentDiv", "subDivs", "no", "numbers", "row", "col", "obj", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [inputObj, noArray, countNumbers, spans, parentDiv, subDivs, no, numbers, row, col, obj, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "getPossibleNumbers", subDivs[no] != inputObj)) 
      {
        ...
        if (confixWrapper("condition", "spans[0].innerHTML == spans[1].innerHTML || subDivs[no].style.backgroundColor.length > 1", ["inputObj", "noArray", "countNumbers", "spans", "parentDiv", "subDivs", "no", "numbers", "row", "col", "obj", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [inputObj, noArray, countNumbers, spans, parentDiv, subDivs, no, numbers, row, col, obj, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "getPossibleNumbers", spans[0].innerHTML == spans[1].innerHTML || subDivs[no].style.backgroundColor.length > 1)) 
        {
          if (confixWrapper("condition", "!noArray[spans[0].innerHTML]", ["inputObj", "noArray", "countNumbers", "spans", "parentDiv", "subDivs", "no", "numbers", "row", "col", "obj", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [inputObj, noArray, countNumbers, spans, parentDiv, subDivs, no, numbers, row, col, obj, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "getPossibleNumbers", !noArray[spans[0].innerHTML])) 
          {
  ...
  for (var no = confixWrapper("initvar", "var no = 0", [""], [], "getPossibleNumbers", 0); confixWrapper("loopCondition", "no < 9", [""], [], "getPossibleNumbers", no < 9); no++) 
    {
      ...
      if (confixWrapper("condition", "obj != inputObj", ["inputObj", "noArray", "countNumbers", "spans", "parentDiv", "subDivs", "no", "numbers", "row", "col", "obj", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [inputObj, noArray, countNumbers, spans, parentDiv, subDivs, no, numbers, row, col, obj, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "getPossibleNumbers", obj != inputObj)) 
      {
        ...
        if (confixWrapper("condition", "spans[0].innerHTML == spans[1].innerHTML || !spans[0].style.display", ["inputObj", "noArray", "countNumbers", "spans", "parentDiv", "subDivs", "no", "numbers", "row", "col", "obj", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [inputObj, noArray, countNumbers, spans, parentDiv, subDivs, no, numbers, row, col, obj, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "getPossibleNumbers", spans[0].innerHTML == spans[1].innerHTML || !spans[0].style.display)) 
        {
          if (confixWrapper("condition", "!noArray[spans[0].innerHTML]", ["inputObj", "noArray", "countNumbers", "spans", "parentDiv", "subDivs", "no", "numbers", "row", "col", "obj", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [inputObj, noArray, countNumbers, spans, parentDiv, subDivs, no, numbers, row, col, obj, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "getPossibleNumbers", !noArray[spans[0].innerHTML])) 
          {
            noArray[spans[0].innerHTML] = confixWrapper("infix", "noArray[spans[0].innerHTML] = true", [""], [], "getPossibleNumbers", true);
...
function showHint() {
  ...
  for (var row = confixWrapper("initvar", "var row = 0", [""], [], "showHint", 0); confixWrapper("loopCondition", "row < 9", [""], [], "showHint", row < 9); row++) 
    {
      for (var col = confixWrapper("initvar", "var col = 0", [""], [], "showHint", 0); confixWrapper("loopCondition", "col < 9", [""], [], "showHint", col < 9); col++) 
        {
          ...
          if (confixWrapper("condition", "obj.style.backgroundColor", ["hintDiv", "hintDivInner", "maxExistingNo", "objectToTry", "row", "col", "obj", "existingNumbers", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [hintDiv, hintDivInner, maxExistingNo, objectToTry, row, col, obj, existingNumbers, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "showHint", obj.style.backgroundColor)) 
          continue;
          if (confixWrapper("condition", "!confixWrapper(\"functionCall\", \"isCorrect(obj)\", [\"obj\"], [obj], \"showHint\", isCorrect(obj))", ["hintDiv", "hintDivInner", "maxExistingNo", "objectToTry", "row", "col", "obj", "existingNumbers", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [hintDiv, hintDivInner, maxExistingNo, objectToTry, row, col, obj, existingNumbers, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "showHint", !confixWrapper("functionCall", "isCorrect(obj)", ["obj"], [obj], "showHint", isCorrect(obj)))) 
          {
          ...
          if (confixWrapper("condition", "existingNumbers > maxExistingNo", ["hintDiv", "hintDivInner", "maxExistingNo", "objectToTry", "row", "col", "obj", "existingNumbers", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [hintDiv, hintDivInner, maxExistingNo, objectToTry, row, col, obj, existingNumbers, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "showHint", existingNumbers > maxExistingNo)) 
          {
  ...
  if (confixWrapper("condition", "objectToTry", ["hintDiv", "hintDivInner", "maxExistingNo", "objectToTry", "row", "col", "obj", "existingNumbers", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [hintDiv, hintDivInner, maxExistingNo, objectToTry, row, col, obj, existingNumbers, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "showHint", objectToTry)) 
  {
...
function revealAll() {
  for (var row = confixWrapper("initvar", "var row = 0", [""], [], "revealAll", 0); confixWrapper("loopCondition", "row < 9", [""], [], "revealAll", row < 9); row++) 
    {
      for (var col = confixWrapper("initvar", "var col = 0", [""], [], "revealAll", 0); confixWrapper("loopCondition", "col < 9", [""], [], "revealAll", col < 9); col++) 
        {
...
function switchLevel(initLevel, linkObj) {
  if (confixWrapper("condition", "linkObj == 'generateDOMInput'", ["initLevel", "linkObj", "confirmSwitch", "parentObj", "links", "no", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [initLevel, linkObj, confirmSwitch, parentObj, links, no, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "switchLevel", linkObj == 'generateDOMInput')) 
  linkObj = confixWrapper("infix", "linkObj = confixWrapper(\"functionCall\", \"document.getElementByID('ConfixDummyNode1')\", [\"ConfixDummyNode1\"], ['ConfixDummyNode1'], \"switchLevel\", document.getElementByID('ConfixDummyNode1'))", [""], [], "switchLevel", confixWrapper("functionCall", "document.getElementByID('ConfixDummyNode1')", ["ConfixDummyNode1"], ['ConfixDummyNode1'], "switchLevel", document.getElementByID('ConfixDummyNode1')));
  var confirmSwitch = confixWrapper("initvar", "var confirmSwitch = gameFinished", [""], [], "switchLevel", gameFinished);
  if (confixWrapper("condition", "!confirmSwitch", ["initLevel", "linkObj", "confirmSwitch", "parentObj", "links", "no", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [initLevel, linkObj, confirmSwitch, parentObj, links, no, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "switchLevel", !confirmSwitch)) 
  ...
  if (confixWrapper("condition", "confirmSwitch", ["initLevel", "linkObj", "confirmSwitch", "parentObj", "links", "no", "squareObjects", "level", "countSquares", "gameFinished", "visibleNumberArray", "higlightedCell", "code"], [initLevel, linkObj, confirmSwitch, parentObj, links, no, squareObjects, level, countSquares, gameFinished, visibleNumberArray, higlightedCell, code], "switchLevel", confirmSwitch)) 
  {
    ...
    for (var no = confixWrapper("initvar", "var no = 0", [""], [], "switchLevel", 0); confixWrapper("loopCondition", "no < links.length", [""], [], "switchLevel", no < links.length); no++) 
      {
