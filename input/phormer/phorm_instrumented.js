...
function setOpac(cur, strength) {
  if (confixWrapper("condition", "cur.style.MozOpacity", ["cur", "strength", "AjaxVal", "isAjaxing", "md5", "ss_cur", "ss_play", "ss_pid", "ss_ttl", "ss_src", "ss_date", "ss_desc", "ss_loaded", "ss_smaller", "ss_awaits"], [cur, strength, AjaxVal, isAjaxing, md5, ss_cur, ss_play, ss_pid, ss_ttl, ss_src, ss_date, ss_desc, ss_loaded, ss_smaller, ss_awaits], "setOpac", cur.style.MozOpacity)) 
  cur.style.MozOpacity = confixWrapper("infix", "cur.style.MozOpacity = strength", [""], [], "setOpac", strength); else if (confixWrapper("condition", "cur.filters", ["cur", "strength", "AjaxVal", "isAjaxing", "md5", "ss_cur", "ss_play", "ss_pid", "ss_ttl", "ss_src", "ss_date", "ss_desc", "ss_loaded", "ss_smaller", "ss_awaits"], [cur, strength, AjaxVal, isAjaxing, md5, ss_cur, ss_play, ss_pid, ss_ttl, ss_src, ss_date, ss_desc, ss_loaded, ss_smaller, ss_awaits], "setOpac", cur.filters)) 
...
function DarkenIt(cur, t) {
  if (confixWrapper("condition", "(!t) || (t == '')", ["cur", "t", "AjaxVal", "isAjaxing", "md5", "ss_cur", "ss_play", "ss_pid", "ss_ttl", "ss_src", "ss_date", "ss_desc", "ss_loaded", "ss_smaller", "ss_awaits"], [cur, t, AjaxVal, isAjaxing, md5, ss_cur, ss_play, ss_pid, ss_ttl, ss_src, ss_date, ss_desc, ss_loaded, ss_smaller, ss_awaits], "DarkenIt", (!t) || (t == ''))) 
...
function toggleInfo(wut) {
  if (confixWrapper("condition", "(!wut) || (wut == '')", ["wut", "AjaxVal", "isAjaxing", "md5", "ss_cur", "ss_play", "ss_pid", "ss_ttl", "ss_src", "ss_date", "ss_desc", "ss_loaded", "ss_smaller", "ss_awaits"], [wut, AjaxVal, isAjaxing, md5, ss_cur, ss_play, ss_pid, ss_ttl, ss_src, ss_date, ss_desc, ss_loaded, ss_smaller, ss_awaits], "toggleInfo", (!wut) || (wut == ''))) 
  ...
  if (confixWrapper("condition", "wut == 'Show'", ["wut", "AjaxVal", "isAjaxing", "md5", "ss_cur", "ss_play", "ss_pid", "ss_ttl", "ss_src", "ss_date", "ss_desc", "ss_loaded", "ss_smaller", "ss_awaits"], [wut, AjaxVal, isAjaxing, md5, ss_cur, ss_play, ss_pid, ss_ttl, ss_src, ss_date, ss_desc, ss_loaded, ss_smaller, ss_awaits], "toggleInfo", wut == 'Show')) 
  {
...
function cookieVal(cookname) {
  ...
  for (i = confixWrapper("infix", "i = 0", [""], [], "cookieVal", 0); confixWrapper("loopCondition", "i < thiscook.length", [""], [], "cookieVal", i < thiscook.length); i++) 
    if (confixWrapper("condition", "cookname == confixWrapper(\"functionCall\", \"thiscook[i].split(\"=\")\", [\"=\"], [\"=\"], \"cookieVal\", thiscook[i].split(\"=\"))[0]", ["cookname", "AjaxVal", "isAjaxing", "md5", "ss_cur", "ss_play", "ss_pid", "ss_ttl", "ss_src", "ss_date", "ss_desc", "ss_loaded", "ss_smaller", "ss_awaits"], [cookname, AjaxVal, isAjaxing, md5, ss_cur, ss_play, ss_pid, ss_ttl, ss_src, ss_date, ss_desc, ss_loaded, ss_smaller, ss_awaits], "cookieVal", cookname == confixWrapper("functionCall", "thiscook[i].split(\"=\")", ["="], ["="], "cookieVal", thiscook[i].split("="))[0])) 
...
function reshuffle() {
  ...
  for (var i = confixWrapper("initvar", "var i = 0", [""], [], "reshuffle", 0); confixWrapper("loopCondition", "i < n", [""], [], "reshuffle", i < n); i++) 
    {
...
function updateIndic() {
  ...
  if (confixWrapper("condition", "l > neck", ["v", "l", "neck", "AjaxVal", "isAjaxing", "md5", "ss_cur", "ss_play", "ss_pid", "ss_ttl", "ss_src", "ss_date", "ss_desc", "ss_loaded", "ss_smaller", "ss_awaits"], [v, l, neck, AjaxVal, isAjaxing, md5, ss_cur, ss_play, ss_pid, ss_ttl, ss_src, ss_date, ss_desc, ss_loaded, ss_smaller, ss_awaits], "updateIndic", l > neck)) 
  ...
  if (confixWrapper("condition", "(l % 3) == 0", ["v", "l", "neck", "AjaxVal", "isAjaxing", "md5", "ss_cur", "ss_play", "ss_pid", "ss_ttl", "ss_src", "ss_date", "ss_desc", "ss_loaded", "ss_smaller", "ss_awaits"], [v, l, neck, AjaxVal, isAjaxing, md5, ss_cur, ss_play, ss_pid, ss_ttl, ss_src, ss_date, ss_desc, ss_loaded, ss_smaller, ss_awaits], "updateIndic", (l % 3) == 0)) 
  ...
  if (confixWrapper("condition", "isAjaxing", ["v", "l", "neck", "AjaxVal", "isAjaxing", "md5", "ss_cur", "ss_play", "ss_pid", "ss_ttl", "ss_src", "ss_date", "ss_desc", "ss_loaded", "ss_smaller", "ss_awaits"], [v, l, neck, AjaxVal, isAjaxing, md5, ss_cur, ss_play, ss_pid, ss_ttl, ss_src, ss_date, ss_desc, ss_loaded, ss_smaller, ss_awaits], "updateIndic", isAjaxing)) 
...
function alertContents(http_request) {
  if (confixWrapper("condition", "http_request.readyState == 4", ["http_request", "AjaxVal", "isAjaxing", "md5", "ss_cur", "ss_play", "ss_pid", "ss_ttl", "ss_src", "ss_date", "ss_desc", "ss_loaded", "ss_smaller", "ss_awaits"], [http_request, AjaxVal, isAjaxing, md5, ss_cur, ss_play, ss_pid, ss_ttl, ss_src, ss_date, ss_desc, ss_loaded, ss_smaller, ss_awaits], "alertContents", http_request.readyState == 4)) 
  try {
    if (confixWrapper("condition", "http_request.status == 200", ["http_request", "AjaxVal", "isAjaxing", "md5", "ss_cur", "ss_play", "ss_pid", "ss_ttl", "ss_src", "ss_date", "ss_desc", "ss_loaded", "ss_smaller", "ss_awaits"], [http_request, AjaxVal, isAjaxing, md5, ss_cur, ss_play, ss_pid, ss_ttl, ss_src, ss_date, ss_desc, ss_loaded, ss_smaller, ss_awaits], "alertContents", http_request.status == 200)) 
    {
      ...
      if (confixWrapper("condition", "confixWrapper(\"functionCall\", \"AjaxVal.substr(0, 4)\", [\"0\", \"4\"], [0, 4], \"alertContents\", AjaxVal.substr(0, 4)) == 'Done'", ["http_request", "AjaxVal", "isAjaxing", "md5", "ss_cur", "ss_play", "ss_pid", "ss_ttl", "ss_src", "ss_date", "ss_desc", "ss_loaded", "ss_smaller", "ss_awaits"], [http_request, AjaxVal, isAjaxing, md5, ss_cur, ss_play, ss_pid, ss_ttl, ss_src, ss_date, ss_desc, ss_loaded, ss_smaller, ss_awaits], "alertContents", confixWrapper("functionCall", "AjaxVal.substr(0, 4)", ["0", "4"], [0, 4], "alertContents", AjaxVal.substr(0, 4)) == 'Done')) 
      {
      ...
      if (confixWrapper("condition", "confixWrapper(\"functionCall\", \"AjaxVal.substr(0, 6)\", [\"0\", \"6\"], [0, 6], \"alertContents\", AjaxVal.substr(0, 6)) == 'FakeWV'", ["http_request", "AjaxVal", "isAjaxing", "md5", "ss_cur", "ss_play", "ss_pid", "ss_ttl", "ss_src", "ss_date", "ss_desc", "ss_loaded", "ss_smaller", "ss_awaits"], [http_request, AjaxVal, isAjaxing, md5, ss_cur, ss_play, ss_pid, ss_ttl, ss_src, ss_date, ss_desc, ss_loaded, ss_smaller, ss_awaits], "alertContents", confixWrapper("functionCall", "AjaxVal.substr(0, 6)", ["0", "6"], [0, 6], "alertContents", AjaxVal.substr(0, 6)) == 'FakeWV')) 
      {
      ...
      if (confixWrapper("condition", "confixWrapper(\"functionCall\", \"AjaxVal.substr(0, 6)\", [\"0\", \"6\"], [0, 6], \"alertContents\", AjaxVal.substr(0, 6)) == 'TrueWV'", ["http_request", "AjaxVal", "isAjaxing", "md5", "ss_cur", "ss_play", "ss_pid", "ss_ttl", "ss_src", "ss_date", "ss_desc", "ss_loaded", "ss_smaller", "ss_awaits"], [http_request, AjaxVal, isAjaxing, md5, ss_cur, ss_play, ss_pid, ss_ttl, ss_src, ss_date, ss_desc, ss_loaded, ss_smaller, ss_awaits], "alertContents", confixWrapper("functionCall", "AjaxVal.substr(0, 6)", ["0", "6"], [0, 6], "alertContents", AjaxVal.substr(0, 6)) == 'TrueWV')) 
      {
...
function makeRequest(url) {
  ...
  if (confixWrapper("condition", "window.XMLHttpRequest", ["url", "http_request", "AjaxVal", "isAjaxing", "md5", "ss_cur", "ss_play", "ss_pid", "ss_ttl", "ss_src", "ss_date", "ss_desc", "ss_loaded", "ss_smaller", "ss_awaits"], [url, http_request, AjaxVal, isAjaxing, md5, ss_cur, ss_play, ss_pid, ss_ttl, ss_src, ss_date, ss_desc, ss_loaded, ss_smaller, ss_awaits], "makeRequest", window.XMLHttpRequest)) 
  {
    http_request = confixWrapper("infix", "http_request = new XMLHttpRequest()", [""], [], "makeRequest", new XMLHttpRequest());
    if (confixWrapper("condition", "http_request.overrideMimeType", ["url", "http_request", "AjaxVal", "isAjaxing", "md5", "ss_cur", "ss_play", "ss_pid", "ss_ttl", "ss_src", "ss_date", "ss_desc", "ss_loaded", "ss_smaller", "ss_awaits"], [url, http_request, AjaxVal, isAjaxing, md5, ss_cur, ss_play, ss_pid, ss_ttl, ss_src, ss_date, ss_desc, ss_loaded, ss_smaller, ss_awaits], "makeRequest", http_request.overrideMimeType)) 
  ...
  } else if (confixWrapper("condition", "window.ActiveXObject", ["url", "http_request", "AjaxVal", "isAjaxing", "md5", "ss_cur", "ss_play", "ss_pid", "ss_ttl", "ss_src", "ss_date", "ss_desc", "ss_loaded", "ss_smaller", "ss_awaits"], [url, http_request, AjaxVal, isAjaxing, md5, ss_cur, ss_play, ss_pid, ss_ttl, ss_src, ss_date, ss_desc, ss_loaded, ss_smaller, ss_awaits], "makeRequest", window.ActiveXObject)) 
  {
    try {
  ...
  if (confixWrapper("condition", "!http_request", ["url", "http_request", "AjaxVal", "isAjaxing", "md5", "ss_cur", "ss_play", "ss_pid", "ss_ttl", "ss_src", "ss_date", "ss_desc", "ss_loaded", "ss_smaller", "ss_awaits"], [url, http_request, AjaxVal, isAjaxing, md5, ss_cur, ss_play, ss_pid, ss_ttl, ss_src, ss_date, ss_desc, ss_loaded, ss_smaller, ss_awaits], "makeRequest", !http_request)) 
  {
...
function SaveRating(pid, rate) {
  if (confixWrapper("condition", "rate == 0", ["pid", "rate", "AjaxVal", "isAjaxing", "md5", "ss_cur", "ss_play", "ss_pid", "ss_ttl", "ss_src", "ss_date", "ss_desc", "ss_loaded", "ss_smaller", "ss_awaits"], [pid, rate, AjaxVal, isAjaxing, md5, ss_cur, ss_play, ss_pid, ss_ttl, ss_src, ss_date, ss_desc, ss_loaded, ss_smaller, ss_awaits], "SaveRating", rate == 0)) 
  {
...
function tableRowElem(x) {
  ...
  if (confixWrapper("condition", "confixWrapper(\"functionCall\", \"dg(x)\", [\"x\"], [x], \"tableRowElem\", dg(x))", ["x", "AjaxVal", "isAjaxing", "md5", "ss_cur", "ss_play", "ss_pid", "ss_ttl", "ss_src", "ss_date", "ss_desc", "ss_loaded", "ss_smaller", "ss_awaits"], [x, AjaxVal, isAjaxing, md5, ss_cur, ss_play, ss_pid, ss_ttl, ss_src, ss_date, ss_desc, ss_loaded, ss_smaller, ss_awaits], "tableRowElem", confixWrapper("functionCall", "dg(x)", ["x"], [x], "tableRowElem", dg(x)))) 
...
function checkWV() {
  ...
  if (confixWrapper("condition", "!confixWrapper(\"functionCall\", \"re.test(dg('wvinput').value)\", [\"dg(wvinput).value\"], [confixWrapper(\"functionCall\", \"dg('wvinput')\", [\"wvinput\"], ['wvinput'], \"checkWV\", dg('wvinput')).value], \"checkWV\", re.test(confixWrapper(\"functionCall\", \"dg('wvinput')\", [\"wvinput\"], ['wvinput'], \"checkWV\", dg('wvinput')).value))", ["ta", "AjaxVal", "isAjaxing", "md5", "ss_cur", "ss_play", "ss_pid", "ss_ttl", "ss_src", "ss_date", "ss_desc", "ss_loaded", "ss_smaller", "ss_awaits"], [ta, AjaxVal, isAjaxing, md5, ss_cur, ss_play, ss_pid, ss_ttl, ss_src, ss_date, ss_desc, ss_loaded, ss_smaller, ss_awaits], "checkWV", !confixWrapper("functionCall", "re.test(dg('wvinput').value)", ["dg(wvinput).value"], [confixWrapper("functionCall", "dg('wvinput')", ["wvinput"], ['wvinput'], "checkWV", dg('wvinput')).value], "checkWV", re.test(confixWrapper("functionCall", "dg('wvinput')", ["wvinput"], ['wvinput'], "checkWV", dg('wvinput')).value)))) 
  {
  ...
  var ta = confixWrapper("initvar", "var ta = confixWrapper(\"functionCall\", \"dg('cmntTextArea')\", [\"cmntTextArea\"], ['cmntTextArea'], \"checkWV\", dg('cmntTextArea')).value", [""], [], "checkWV", confixWrapper("functionCall", "dg('cmntTextArea')", ["cmntTextArea"], ['cmntTextArea'], "checkWV", dg('cmntTextArea')).value);
  if (confixWrapper("condition", "ta.length == 0", ["ta", "AjaxVal", "isAjaxing", "md5", "ss_cur", "ss_play", "ss_pid", "ss_ttl", "ss_src", "ss_date", "ss_desc", "ss_loaded", "ss_smaller", "ss_awaits"], [ta, AjaxVal, isAjaxing, md5, ss_cur, ss_play, ss_pid, ss_ttl, ss_src, ss_date, ss_desc, ss_loaded, ss_smaller, ss_awaits], "checkWV", ta.length == 0)) 
  {
...
function doReply(x) {
  ...
  if (confixWrapper("condition", "x == 0", ["x", "AjaxVal", "isAjaxing", "md5", "ss_cur", "ss_play", "ss_pid", "ss_ttl", "ss_src", "ss_date", "ss_desc", "ss_loaded", "ss_smaller", "ss_awaits"], [x, AjaxVal, isAjaxing, md5, ss_cur, ss_play, ss_pid, ss_ttl, ss_src, ss_date, ss_desc, ss_loaded, ss_smaller, ss_awaits], "doReply", x == 0)) 
...
function ss_update() {
  ...
  if (confixWrapper("condition", "ss_cur >= ss_date.length", ["AjaxVal", "isAjaxing", "md5", "ss_cur", "ss_play", "ss_pid", "ss_ttl", "ss_src", "ss_date", "ss_desc", "ss_loaded", "ss_smaller", "ss_awaits"], [AjaxVal, isAjaxing, md5, ss_cur, ss_play, ss_pid, ss_ttl, ss_src, ss_date, ss_desc, ss_loaded, ss_smaller, ss_awaits], "ss_update", ss_cur >= ss_date.length)) 
  {
    ...
    if (confixWrapper("condition", "ss_play", ["AjaxVal", "isAjaxing", "md5", "ss_cur", "ss_play", "ss_pid", "ss_ttl", "ss_src", "ss_date", "ss_desc", "ss_loaded", "ss_smaller", "ss_awaits"], [AjaxVal, isAjaxing, md5, ss_cur, ss_play, ss_pid, ss_ttl, ss_src, ss_date, ss_desc, ss_loaded, ss_smaller, ss_awaits], "ss_update", ss_play)) 
...
function src_smaller(x) {
  if (confixWrapper("condition", "confixWrapper(\"functionCall\", \"x.charAt(x.length - 1)\", [\"x.length - 1\"], [x.length - 1], \"src_smaller\", x.charAt(x.length - 1)) == \")\"", ["x", "AjaxVal", "isAjaxing", "md5", "ss_cur", "ss_play", "ss_pid", "ss_ttl", "ss_src", "ss_date", "ss_desc", "ss_loaded", "ss_smaller", "ss_awaits"], [x, AjaxVal, isAjaxing, md5, ss_cur, ss_play, ss_pid, ss_ttl, ss_src, ss_date, ss_desc, ss_loaded, ss_smaller, ss_awaits], "src_smaller", confixWrapper("functionCall", "x.charAt(x.length - 1)", ["x.length - 1"], [x.length - 1], "src_smaller", x.charAt(x.length - 1)) == ")")) 
...
function ss_run() {
  if (confixWrapper("condition", "(ss_play) && (ss_awaits <= 0)", ["lookup", "AjaxVal", "isAjaxing", "md5", "ss_cur", "ss_play", "ss_pid", "ss_ttl", "ss_src", "ss_date", "ss_desc", "ss_loaded", "ss_smaller", "ss_awaits"], [lookup, AjaxVal, isAjaxing, md5, ss_cur, ss_play, ss_pid, ss_ttl, ss_src, ss_date, ss_desc, ss_loaded, ss_smaller, ss_awaits], "ss_run", (ss_play) && (ss_awaits <= 0))) 
  {
    ss_awaits++;
...
function ss_slideshow() {
  ss_awaits--;
  if (confixWrapper("condition", "ss_play == 1 && ss_loaded", ["AjaxVal", "isAjaxing", "md5", "ss_cur", "ss_play", "ss_pid", "ss_ttl", "ss_src", "ss_date", "ss_desc", "ss_loaded", "ss_smaller", "ss_awaits"], [AjaxVal, isAjaxing, md5, ss_cur, ss_play, ss_pid, ss_ttl, ss_src, ss_date, ss_desc, ss_loaded, ss_smaller, ss_awaits], "ss_slideshow", ss_play == 1 && ss_loaded)) 
  {
    ss_cur++;
