...
test("Testing function createNewTaskElement('test') for path 1", function() {
	expect(0);
	...
	createNewTaskElement('test');
});


test("Testing function createNewTaskElement('test') for path 2", function() {
	expect(0);
