...
test("Testing function uploadSubmitted('test', 'test', 'test', 'test')  for path 1", function() {
	expect(0);
	$("#qunit-fixture").append(' <div id="upload_uploading_txt_test"/> ');
	uploadSubmitted('test', 'test', 'test', 'test') ;
});


test("Testing function uploadSubmitted('test', 'test', 'test', 'test')  for path 2", function() {
	expect(0);
