...
test("Testing function DraftsSelectBit('test','test') for path 1", function() {
	expect(0);
	$("#qunit-fixture").append(' <div id="selCount1"/> <input id="ConfixGeneID1"/> <input id="ConfixGeneID0"/> ');
	DraftsSelectBit('test','test');
});


test("Testing function DraftsSelectBit('test','test') for path 2", function() {
	expect(0);
