...
test("Testing function shuffleBoard() for path 1", function() {
	expect(0);
	$("#qunit-fixture").append(' <div value="" style="display:initial" id="square_2_0"/> <div value="" style="display:initial" id="sudoku"/> <div id="hintDiv" value="" style="display:initial"/> ');
	shuffleBoard();
});


test("Testing function shuffleBoard() for path 2", function() {
	expect(0);
	$("#qunit-fixture").append(' <div value="" style="display:initial" id="square_5_4"/> <div value="" style="display:initial" id="sudoku"/> <div id="hintDiv" value="" style="display:initial"/> ');
	shuffleBoard();
});


test("Testing function shuffleBoard() for path 3", function() {
	expect(0);
	$("#qunit-fixture").append(' <div value="" style="display:initial" id="square_1_5"/> <div value="" style="display:initial" id="sudoku"/> <div id="hintDiv" value="" style="display:initial"/> ');
	shuffleBoard();
});


test("Testing function shuffleBoard() for path 4", function() {
	expect(0);
	$("#qunit-fixture").append(' <div value="" style="display:initial" id="square_5_3"/> <div value="" style="display:initial" id="sudoku"/> <div id="hintDiv" value="" style="display:initial"/> ');
	shuffleBoard();
});


test("Testing function shuffleBoard() for path 5", function() {
	expect(0);
	$("#qunit-fixture").append(' <div value="" style="display:initial" id="square_8_5"/> <div value="" style="display:initial" id="sudoku"/> <div id="hintDiv" value="" style="display:initial"/> ');
	shuffleBoard();
});


test("Testing function shuffleBoard() for path 6", function() {
	expect(0);
	$("#qunit-fixture").append(' <div value="" style="display:initial" id="square_4_2"/> <div value="" style="display:initial" id="sudoku"/> <div id="hintDiv" value="" style="display:initial"/> ');
	shuffleBoard();
});


test("Testing function shuffleBoard() for path 7", function() {
	expect(0);
	$("#qunit-fixture").append(' <div value="" style="display:initial" id="square_3_2"/> <div value="" style="display:initial" id="sudoku"/> <div id="hintDiv" value="" style="display:initial"/> ');
	shuffleBoard();
});


test("Testing function shuffleBoard() for path 8", function() {
	expect(0);
	$("#qunit-fixture").append(' <div value="" style="display:initial" id="square_1_2"/> <div value="" style="display:initial" id="sudoku"/> <div id="hintDiv" value="" style="display:initial"/> ');
	shuffleBoard();
});


test("Testing function shuffleBoard() for path 9", function() {
	expect(0);
	$("#qunit-fixture").append(' <div value="" style="display:initial" id="square_8_6"/> <div value="" style="display:initial" id="sudoku"/> <div id="hintDiv" value="" style="display:initial"/> ');
	shuffleBoard();
});
...
test("Testing function showColumnsInGroup() for path 2", function() {
	expect(0);
	$("#qunit-fixture").append(' <div value="" style="display:initial" id="square_1_0"/> <div value="" style="display:initial" id="sudoku"/> <div id="hintDiv" value="" style="display:initial"/> ');
	showColumnsInGroup();
});
...
test("Testing function showColumnsInGroup() for path 3", function() {
	expect(0);
	$("#qunit-fixture").append(' <div value="" style="display:initial" id="square_4_3"/> <div value="" style="display:initial" id="sudoku"/> <div id="hintDiv" value="" style="display:initial"/> ');
	showColumnsInGroup();
});
...
test("Testing function showColumnsInGroup() for path 4", function() {
	expect(0);
	$("#qunit-fixture").append(' <div value="" style="display:initial" id="square_6_1"/> <div value="" style="display:initial" id="sudoku"/> <div id="hintDiv" value="" style="display:initial"/> ');
	showColumnsInGroup();
});
...
test("Testing function showColumnsInGroup() for path 5", function() {
	expect(0);
	$("#qunit-fixture").append(' <div value="" style="display:initial" id="square_1_8"/> <div value="" style="display:initial" id="sudoku"/> <div id="hintDiv" value="" style="display:initial"/> ');
	showColumnsInGroup();
});
...
test("Testing function showColumnsInGroup() for path 6", function() {
	expect(0);
	$("#qunit-fixture").append(' <div value="" style="display:initial" id="square_3_6"/> <div value="" style="display:initial" id="sudoku"/> <div id="hintDiv" value="" style="display:initial"/> ');
	showColumnsInGroup();
});
...
test("Testing function showColumnsInGroup() for path 7", function() {
	expect(0);
	$("#qunit-fixture").append(' <div value="" style="display:initial" id="square_3_5"/> <div value="" style="display:initial" id="sudoku"/> <div id="hintDiv" value="" style="display:initial"/> ');
	showColumnsInGroup();
});
...
test("Testing function showColumnsInGroup() for path 9", function() {
	expect(0);
	$("#qunit-fixture").append(' <div value="" style="display:initial" id="square_8_1"/> <div value="" style="display:initial" id="sudoku"/> <div id="hintDiv" value="" style="display:initial"/> ');
	showColumnsInGroup();
});
...
test("Testing function helpMe() for path 1", function() {
	expect(0);
	$("#qunit-fixture").append(' <div value="" style="display:initial" id="square_5_5"/> <div id="hintDiv" value="" style="display:initial"/> ');
	helpMe();
});
...
test("Testing function helpMe() for path 2", function() {
	expect(0);
	$("#qunit-fixture").append(' <div value="" style="display:initial" id="square_6_7"/> <div id="hintDiv" value="" style="display:initial"/> ');
	helpMe();
});
...
test("Testing function helpMe() for path 3", function() {
	expect(0);
	$("#qunit-fixture").append(' <div value="" style="display:initial" id="square_3_5"/> <div id="hintDiv" value="" style="display:initial"/> ');
	helpMe();
});
...
test("Testing function helpMe() for path 5", function() {
	expect(0);
	$("#qunit-fixture").append(' <div value="" style="display:initial" id="square_4_6"/> <div id="hintDiv" value="" style="display:initial"/> ');
	helpMe();
});
...
test("Testing function helpMe() for path 6", function() {
	expect(0);
	$("#qunit-fixture").append(' <div value="" style="display:initial" id="square_0_7"/> <div id="hintDiv" value="" style="display:initial"/> ');
	helpMe();
});
...
test("Testing function helpMe() for path 7", function() {
	expect(0);
	$("#qunit-fixture").append(' <div value="" style="display:initial" id="square_6_1"/> <div id="hintDiv" value="" style="display:initial"/> ');
	helpMe();
});
...
test("Testing function helpMe() for path 8", function() {
	expect(0);
	$("#qunit-fixture").append(' <div value="" style="display:initial" id="square_3_6"/> <div id="hintDiv" value="" style="display:initial"/> ');
	helpMe();
});
...
test("Testing function helpMe() for path 9", function() {
	expect(0);
	$("#qunit-fixture").append(' <div value="" style="display:initial" id="square_0_1"/> <div id="hintDiv" value="" style="display:initial"/> ');
	helpMe();
});
