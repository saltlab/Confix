...
public class NodeMutator {
	...
	public boolean mutateDomJsCodeLevel(List<Object> domJsCodeLevel){
		...
		String original = nodeToMutate.toSource();
		...
		// For Testilizer!
		if(ischanged){
			result.append("Original: " + original + " in " + scopeName+"\n"+"----------"+"\n");
			result.append("Function " + getFunctionName(nodeToMutate.getEnclosingFunction())+"\n"+"----------"+"\n");
			result.append(typeOfcode+"\n"+"----------"+"\n");
			result.append("Modified: " + nodeToMutate.toSource()+"\n");
			result.append("================"+"\n");
			writeResultsToFile(result.toString());
		}
